  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="lg:col-span-5 bg-[var(--primary)] rounded-2xl p-8 relative overflow-hidden"
            >
      ...
      <section className="bg-gray-50 overflow-hidden">
            ...
            {engineeringServices.map((svc, i) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="group relative bg-[var(--secondary)]/5 hover:bg-[var(--secondary)]/10 rounded-2xl border border-gray-100 p-10 hover:border-[var(--primary)]/25 hover:shadow-lg hover:shadow-[var(--primary)]/5 transition-all duration-400 overflow-hidden"
                >

                  <span className="absolute top-0 left-0 w-0 h-[3px] bg-[var(--primary)] group-hover:w-full transition-all duration-600 ease-out" />

                  <span className="absolute top-4 right-2 text-[80px] font-black leading-none text-[var(--primary)]/5 select-none pointer-events-none">
                    {svc.number}
                  </span>

                  <div className="flex items-center gap-4 mb-6">

                    <div className="w-12 h-12 rounded-xl bg-[var(--primary)]/8 border border-[var(--primary)]/15 flex items-center justify-center group-hover:bg-[var(--primary)] group-hover:border-[var(--primary)] transition-all duration-300">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {svc.tags.map((tag) => (
                      ...
                      <span
                        key={tag}
                        className="text-[10px] font-semibold text-[var(--primary)]/70 bg-[var(--secondary)]/20 border border-[var(--primary)]/15 px-3 py-1 rounded-full uppercase tracking-[2px]"
                      >
                        {tag}
                      </span>
        ...
        {/* CTA */}
        <div className="relative mx-4 sm:mx-6 lg:mx-16 my-16 rounded-2xl bg-[var(--primary)] px-6 sm:px-10 py-10 sm:py-14 overflow-hidden">
