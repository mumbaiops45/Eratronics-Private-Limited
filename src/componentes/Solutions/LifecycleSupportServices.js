            ...
            return (
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <div className="w-12 h-12 rounded-xl bg-[var(--primary)]/8 border border-[var(--primary)]/15 flex items-center justify-center shrink-0 group-hover:bg-[var(--primary)] group-hover:border-[var(--primary)] transition-all duration-300">
                  ...
                  <div>
                    ...
                    <h3 className="text-lg font-bold text-gray-900 leading-snug group-hover:text-[var(--primary)] transition-colors duration-300">
                      {svc.title}
                    </h3>
                ...
                {/* KPIs */}
                {svc.kpis && (
                  <div className="mt-5 border border-[var(--primary)]/15 bg-[var(--primary)]/5 rounded-xl p-5">

                    <span className="block text-[10px] font-semibold text-[var(--primary)] uppercase tracking-[3px] mb-3">
                      Key KPIs
                    </span>
