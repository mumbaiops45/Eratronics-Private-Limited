    ...
    >
      <div className="mx-auto px-6 lg:px-16 pt-24">
        ...
        >
          ...
          >
            Our framework ensures telecom systems remain reliable, secure,
            scalable, and efficient across every stage of their operational life.
          </p>
        </div>
        ...
        >
          {lifecycleServices.map((svc, i) => {
            ...
            return (
              <div
                key={svc.number}
                className="lc-card group relative p-8 overflow-hidden transition-all duration-500"
                style={{
                  borderRight:
                    i % 2 === 0
              ...
              >
                ...
                {/* Left hover line */}
                <div
                  className="absolute top-0 bottom-0 left-0 w-0.5 scale-y-0 group-hover:scale-y-100 origin-top transition-transform duration-500"
                  style={{ background: "var(--secondary)" }}
                />
                ...
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <span
                    className="ml-auto text-xl font-black tabular-nums shrink-0 transition-all duration-300 group-hover:translate-x-1"
                    style={{ color: "rgba(33,150,243,0.15)" }}
                  >
                    {svc.number}
                  </span>
                </div>
                ...
                {svc.kpis && (
                  <div
                    className="p-5 mt-2 transition-all duration-300 group-hover:translate-x-1 group-hover:-translate-y-1"
                    style={{
                  ...
                  >
                    <span
                      className="block text-[10px] font-bold uppercase tracking-[0.12em] mb-3"
          ...
          >
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
              <div>
                ...
                >
                  From go live to end of life, our ETCP keeps your mission
                  critical systems running at full availability, every phase of
                  the way.
                </p>
              </div>
              ...
              <Link
                href="/contact-us"
                className="flex items-center gap-2.5 px-8 py-4 font-bold text-sm shrink-0 transition-all duration-300"
                style={{
