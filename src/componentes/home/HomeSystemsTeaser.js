        ...
        >
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight max-w-2xl">
              Intelligent Telecom Systems for{" "}
              <span className="text-[var(--primary)]">Every Layer</span>
            </h2>
          </div>
          <Link
            href="/systems-we-offer"
            className="group inline-flex items-center gap-2 text-sm font-semibold text-[var(--primary)] border border-[var(--primary)]/30 px-6 py-3 rounded-full hover:bg-[var(--primary)] hover:text-white hover:border-[var(--primary)] transition-all duration-300 self-start lg:self-auto"
          >
            View All Systems
          ...
          {systems.map((sys, i) => {
            ...
            return (
              ...
              >
                <Link
                  href="/systems-we-offer"
                  className="group flex flex-col items-center text-center p-8 bg-white border border-gray-100 rounded-xl hover:border-[var(--primary)]/30 hover:shadow-lg hover:shadow-[var(--primary)]/5 transition-all duration-300"
                >
                  <div className="w-14 h-14 rounded-xl bg-[var(--primary)]/6 flex items-center justify-center mb-4 group-hover:bg-[var(--primary)] transition-all duration-300">
                    <Icon className="text-[var(--primary)] group-hover:text-white transition-colors duration-300" size={22} />
                  </div>
