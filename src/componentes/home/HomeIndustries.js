    ...
    <section className="py-28 bg-[var(--primary)] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-20 flex items-center gap-18"
        >
          <div className="flex items-center gap-3 mb-6">
           ...
           <span className="block w-px h-20 bg-white/30" />
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {industries.map((ind, i) => (
            ...
            >
              <Link
                href={ind.href}
                className="group relative flex flex-col h-full bg-[var(--secondary)]/5 border border-white/10 rounded-2xl overflow-hidden hover:border-white/20 transition-all duration-500 p-8"
              >
                {/* Top accent */}
